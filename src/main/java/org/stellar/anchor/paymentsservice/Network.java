...
public enum Network {
    ...
    /**
     * Currency prefix is based on SEP-38 identification format: https://github.com/stellar/stellar-protocol/blob/65c9c20/ecosystem/sep-0038.md#asset-identification-format
     */
