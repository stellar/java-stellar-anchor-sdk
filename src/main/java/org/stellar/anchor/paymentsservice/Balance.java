...
public class Balance {
     ...
     * @param currencyName The name of the currency that will be ultimately credited into the destination account. It
     *                     should obey the {scheme}:{identifier} format described in
     *                     <a href="https://stellar.org/protocol/sep-38#asset-identification-format">SEP-38</a>.
     */
