...
public class WithdrawTransactionResponse extends TransactionResponse {
    ...
    public static WithdrawTransactionResponse of(JwtService jwtService, Sep24Config sep24Config, Sep24Transaction txn, boolean allowMoreInfoUrl) throws MalformedURLException, URISyntaxException {
    ...
    private static List<String> needsMoreInfoUrlWithdraw = Arrays.asList(
