...
object Customers : Table() {
  ...
  val photoIdFront = binary("photo_id_front", 1048576).nullable()
  val photoIdBack = binary("photo_id_back", 1048576).nullable()
  val notaryApprovalOfPhotoId = binary("notary_approval_of_photo_id", 1048576).nullable()
  val ipAddress = varchar("ip_address", 255).nullable()
  val photoProofResidence = binary("photo_proof_residence", 1048576).nullable()
  val sex = varchar("sex", 255).nullable()
  val photoProofOfIncome = binary("photo_proof_of_income", 1048576).nullable()
  val proofOfLiveness = binary("proof_of_liveness", 1048576).nullable()
