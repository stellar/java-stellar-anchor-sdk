...
internal class Sep10TokenFilterTest {
    ...
    fun testValidationError(method: String) {
        ...
        every {
            mockFilter.validate(any())
        } answers {
            throw Exception("Not validate")
        }
    ...
    fun testValidToken(method: String) {
        ...
        verify(exactly = 1) {
            request.setAttribute(JWT_TOKEN, any())
        }
    ...
    private fun createJwtToken(): String {
        ...
        val jwtToken = JwtToken.of(
            appConfig.hostUrl + "/auth", PUBLIC_KEY, issuedAt, issuedAt + 60, "", "vibrant.stellar.org"
        )
