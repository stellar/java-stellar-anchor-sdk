...
public interface PaymentService {
   ...
   * @param cursor the value used to limit payments to only those after it
   * @return asynchronous stream with the payment history.
   * @throws HttpException If the http response status code is 4xx or 5xx.
   */
  Mono<PaymentHistory> getAccountPaymentHistory(String accountID, @Nullable String cursor)
