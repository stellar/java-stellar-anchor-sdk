...
class NotifyRefundSentHandlerTest {
  ...
  fun setup() {
    ...
    this.handler = NotifyRefundSentHandler(txn24Store, txn31Store, validator, horizon, assetService)
  }
  ...
  fun test_handle_unsupportedProtocol() {
    ...
    assertEquals("Protocol[100] is not supported by action[notify_refund_sent]", ex.message)
  }
  ...
  fun test_handle_unsupportedStatus() {
    ...
    assertEquals("Action[notify_refund_sent] is not supported for status[incomplete]", ex.message)
  ...
  fun test_handle_invalidRequest() {
    ...
    val violation1: ConstraintViolation<NotifyRefundSentRequest> = mockk()
    val violation2: ConstraintViolation<NotifyRefundSentRequest> = mockk()
  ...
  fun test_handle_ok_partial_refund() {
    ...
    expectedSep24Txn.status = SepTransactionStatus.PENDING_ANCHOR.toString()
    ...
    expectedResponse.status = SepTransactionStatus.PENDING_ANCHOR
