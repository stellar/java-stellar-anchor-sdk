...
@Data
public class PropertyClientsConfig_DEPRECATED implements ClientsConfig_DEPRECATED, Validator {
  List<ClientConfig_DEPRECATED> clients = Lists.newLinkedList();
  Map<String, ClientConfig_DEPRECATED> clientMap = null;
  ...
  @Override
  public ClientConfig_DEPRECATED getClientConfigBySigningKey(String signingKey) {
  ...
  @Override
  public ClientConfig_DEPRECATED getClientConfigByDomain(String domain) {
  ...
  public ClientConfig_DEPRECATED getClientConfigByName(String name) {
    if (clientMap == null) {
  ...
  public boolean supports(@NotNull Class<?> clazz) {
    return PropertyClientsConfig_DEPRECATED.class.isAssignableFrom(clazz);
  }

  @Override
  public void validate(@NotNull Object target, @NotNull Errors errors) {
    PropertyClientsConfig_DEPRECATED configs = (PropertyClientsConfig_DEPRECATED) target;
    configs.clients.forEach(clientConfig -> validateClient(clientConfig, errors));
  }

  private void validateClient(ClientConfig_DEPRECATED clientConfig, Errors errors) {
  ...
  public void validateCustodialClient(ClientConfig_DEPRECATED clientConfig, Errors errors) {
    if (isEmpty(clientConfig.getSigningKey())
  ...
  public void validateNonCustodialClient(ClientConfig_DEPRECATED clientConfig, Errors errors) {
    if (isEmpty(clientConfig.getDomain())
