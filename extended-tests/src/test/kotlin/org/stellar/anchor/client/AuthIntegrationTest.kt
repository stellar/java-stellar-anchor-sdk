...
import org.stellar.anchor.client.AbstractIntegrationTest.Companion.ANCHOR_TO_PLATFORM_SECRET
import org.stellar.anchor.client.AbstractIntegrationTest.Companion.CUSTODY_SERVER_SERVER_PORT
import org.stellar.anchor.client.AbstractIntegrationTest.Companion.JWT_EXPIRATION_MILLISECONDS
import org.stellar.anchor.client.AbstractIntegrationTest.Companion.PLATFORM_TO_ANCHOR_SECRET
import org.stellar.anchor.client.AbstractIntegrationTest.Companion.PLATFORM_TO_CUSTODY_SECRET
...
internal class CustodyJwtAuthIntegrationTest : AbstractAuthIntegrationTest() {
  ...
  private val jwtCustodyClient: org.stellar.anchor.client.apiclient.CustodyApiClient =
    org.stellar.anchor.client.apiclient.CustodyApiClient(
      httpClient,
      jwtAuthHelper,
      custodyApiConfig
    )
  private val jwtWrongKeyCustodyClient: org.stellar.anchor.client.apiclient.CustodyApiClient =
    org.stellar.anchor.client.apiclient.CustodyApiClient(
      httpClient,
      jwtWrongKeyAuthHelper,
      custodyApiConfig
    )
  private val jwtExpiredTokenCustodyClient: org.stellar.anchor.client.apiclient.CustodyApiClient =
    org.stellar.anchor.client.apiclient.CustodyApiClient(
      httpClient,
      jwtExpiredAuthHelper,
      custodyApiConfig
