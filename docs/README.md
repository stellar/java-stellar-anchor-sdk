...
[![Docker](https://badgen.net/badge/Latest%20Release/v2.6.2/blue?icon=docker)](https://hub.docker.com/r/stellar/anchor-platform/tags?page=1&name=2.6.2)
...
```shell
docker build --build-arg BASE_IMAGE=gradle:8.2.1-jdk17-alpine -t anchor-platform:local ./
